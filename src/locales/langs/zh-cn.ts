const local: App.I18n.Schema = {
  ...
  route: {
    ...
    management: '档案管理',
    emergency: '急修调度中心',
    management_community: '项目/小区管理',
    management_equipment: '电梯设备管理',
    management_maintenancegroup: '维保小组管理',
    management_knowledge: '维保知识库',
    management_organizational: '组织单位管理',
    management_component: '电梯组件管理',
    business: '业务调度',
    business_repair: '维修管理',
    business_report: '报表统计',
    system: '系统配置',
    system_person: '人员管理',
    system_roles: '角色管理',
    ...
    safetysystem_managementpersonnel: '安全管理人员',
    safetysystem_daily: '日管控',
