const local: App.I18n.Schema = {
  ...
  route: {
    ...
    annual: 'Annual Inspection Scheduling',
    emergency: 'Emergency Repair Dispatch Center',
    management_community: 'Project / Community Management',
    business: 'Business Dispatch',
    system_menu: 'Menu Management',
    system_customworkbench: 'Custom Workbench',
    system_maintainparams: 'Maintenance Parameters',
    monitoring_demo: 'Monitoring Demo',
    monitoring_detail: 'Monitoring Detail',
    safetysystem: 'Safety Responsibility System',
    safetysystem_checklist: 'Risk Control Checklist',
    safetysystem_managementpersonnel: 'Safety Management Personnel',
    safetysystem_daily: 'Daily Control',
    safetysystem_monthcontrol: 'Monthly Control',
    safetysystem_weeklycontrol: 'Weekly Control',
    safetysystem_archive: 'Archive',
    safetysystem_training: 'Training and Assessment',
    safety_compliance: 'Safety Compliance',
    safety_personnel: 'Safety Personnel',
    safety_checklist: 'Safety Checklist',
    safety_daily: 'Safety Daily Control',
    safety_hazard: 'Hazard Inspection',
    safety_weekly: 'Safety Weekly Control',
    safety_monthly: 'Safety Monthly Control',
    safety_training: 'Safety Training',
    safety_archive: 'Safety Archive',
    management_community_detail: 'Community Detail'
  },
  page: {
    login: {
      common: {
